...
local Settings = {
    ...
    AFK2_MinDelay = 0.1,       -- For random mode
    AFK2_MaxDelay = 0.5,       -- For random mode
    -- Extreme Settings
...
local function createCompleteGUI()
    ...
    -- TP Player Frame (Improved)
    local TPPlayer = Instance.new("Frame")
    TPPlayer.Name = "TPPlayer"
    TPPlayer.Parent = TeleportContainer
    TPPlayer.BackgroundColor3 = Color3.fromRGB(47, 47, 47)
    TPPlayer.BorderSizePixel = 0
    TPPlayer.Size = UDim2.new(0.898, 0, 0.106, 0)
    TPPlayer.LayoutOrder = 1
    
    local tpPlayerCorner = Instance.new("UICorner")
    tpPlayerCorner.Parent = TPPlayer

    local TPPlayerIcon = Instance.new("TextLabel")
    TPPlayerIcon.Parent = TPPlayer
    TPPlayerIcon.BackgroundTransparency = 1
    TPPlayerIcon.Position = UDim2.new(0.020, 0, 0.200, 0)
    TPPlayerIcon.Size = UDim2.new(0.080, 0, 0.600, 0)
    TPPlayerIcon.Font = Enum.Font.SourceSansBold
    TPPlayerIcon.Text = "👤"
    TPPlayerIcon.TextColor3 = Color3.fromRGB(0, 150, 255)
    TPPlayerIcon.TextScaled = true

    local TPPlayerText = Instance.new("TextLabel")
    TPPlayerText.Parent = TPPlayer
    TPPlayerText.BackgroundTransparency = 1
    TPPlayerText.Position = UDim2.new(0.120, 0, 0.216, 0)
    TPPlayerText.Size = UDim2.new(0.500, 0, 0.568, 0)
    TPPlayerText.Font = Enum.Font.SourceSansBold
    TPPlayerText.Text = "TELEPORT TO PLAYER"
    ...
    TPPlayerButton.BackgroundColor3 = Color3.fromRGB(0, 150, 255)
    TPPlayerButton.BorderSizePixel = 0
    TPPlayerButton.Position = UDim2.new(0.750, 0, 0.108, 0)
    TPPlayerButton.Size = UDim2.new(0.220, 0, 0.784, 0)
    ...
    tpPlayerButtonCorner.CornerRadius = UDim.new(0, 6)
    ...
    ListOfTpPlayer.Parent = TeleportContainer
    ListOfTpPlayer.Active = true
    ListOfTpPlayer.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
    ListOfTpPlayer.BackgroundTransparency = 0.1
    ListOfTpPlayer.BorderSizePixel = 0
    ListOfTpPlayer.Size = UDim2.new(0.898, 0, 0.200, 0)
    ...
    ListOfTpPlayer.LayoutOrder = 2
    
    local playerListCorner = Instance.new("UICorner")
    playerListCorner.CornerRadius = UDim.new(0, 8)
    playerListCorner.Parent = ListOfTpPlayer

    local PlayerListLayout = Instance.new("UIListLayout")
    PlayerListLayout.Parent = ListOfTpPlayer
    PlayerListLayout.HorizontalAlignment = Enum.HorizontalAlignment.Center
    PlayerListLayout.SortOrder = Enum.SortOrder.LayoutOrder
    PlayerListLayout.Padding = UDim.new(0, 4)

    -- TP Islands Frame (Improved)
    local TPIsland = Instance.new("Frame")
    TPIsland.Name = "TPIsland"
    TPIsland.Parent = TeleportContainer
    TPIsland.BackgroundColor3 = Color3.fromRGB(47, 47, 47)
    TPIsland.BorderSizePixel = 0
    TPIsland.Size = UDim2.new(0.898, 0, 0.106, 0)
    TPIsland.LayoutOrder = 3
    
    local tpIslandCorner = Instance.new("UICorner")
    tpIslandCorner.Parent = TPIsland

    local TPIslandIcon = Instance.new("TextLabel")
    TPIslandIcon.Parent = TPIsland
    TPIslandIcon.BackgroundTransparency = 1
    TPIslandIcon.Position = UDim2.new(0.020, 0, 0.200, 0)
    TPIslandIcon.Size = UDim2.new(0.080, 0, 0.600, 0)
    TPIslandIcon.Font = Enum.Font.SourceSansBold
    TPIslandIcon.Text = "🏝️"
    TPIslandIcon.TextColor3 = Color3.fromRGB(0, 255, 127)
    TPIslandIcon.TextScaled = true

    local TPIslandText = Instance.new("TextLabel")
    TPIslandText.Parent = TPIsland
    TPIslandText.BackgroundTransparency = 1
    TPIslandText.Position = UDim2.new(0.120, 0, 0.216, 0)
    TPIslandText.Size = UDim2.new(0.500, 0, 0.568, 0)
    TPIslandText.Font = Enum.Font.SourceSansBold
    TPIslandText.Text = "TELEPORT TO ISLAND"
    ...
    TPIslandButton.BackgroundColor3 = Color3.fromRGB(0, 255, 127)
    TPIslandButton.BorderSizePixel = 0
    TPIslandButton.Position = UDim2.new(0.750, 0, 0.108, 0)
    TPIslandButton.Size = UDim2.new(0.220, 0, 0.784, 0)
    ...
    tpIslandButtonCorner.CornerRadius = UDim.new(0, 6)
    tpIslandButtonCorner.Parent = TPIslandButton

    -- Enhanced Island List
    local ListOfTPIsland = Instance.new("ScrollingFrame")
    ListOfTPIsland.Name = "ListOfTPIsland"
    ListOfTPIsland.Parent = TeleportContainer
    ListOfTPIsland.Active = true
    ListOfTPIsland.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
    ListOfTPIsland.BackgroundTransparency = 0.1
    ListOfTPIsland.BorderSizePixel = 0
    ListOfTPIsland.Size = UDim2.new(0.898, 0, 0.250, 0)
    ...
    ListOfTPIsland.LayoutOrder = 4
    
    local islandListCorner = Instance.new("UICorner")
    islandListCorner.CornerRadius = UDim.new(0, 8)
    islandListCorner.Parent = ListOfTPIsland

    local IslandListLayout = Instance.new("UIListLayout")
    IslandListLayout.Parent = ListOfTPIsland
    IslandListLayout.HorizontalAlignment = Enum.HorizontalAlignment.Center
    ...
    QuickTPFrame.Parent = TeleportContainer
    QuickTPFrame.BackgroundColor3 = Color3.fromRGB(60, 60, 60)
    QuickTPFrame.BorderSizePixel = 0
    QuickTPFrame.Size = UDim2.new(0.898, 0, 0.150, 0)
    QuickTPFrame.LayoutOrder = 5
    
    local quickTPCorner = Instance.new("UICorner")
    quickTPCorner.Parent = QuickTPFrame

    local QuickTPTitle = Instance.new("TextLabel")
    QuickTPTitle.Parent = QuickTPFrame
    QuickTPTitle.BackgroundTransparency = 1
    QuickTPTitle.Position = UDim2.new(0.020, 0, 0.050, 0)
    QuickTPTitle.Size = UDim2.new(0.960, 0, 0.200, 0)
    QuickTPTitle.Font = Enum.Font.SourceSansBold
    QuickTPTitle.Text = "⚡ QUICK TELEPORTS"
    QuickTPTitle.TextColor3 = Color3.fromRGB(255, 215, 0)
    QuickTPTitle.TextScaled = true

    -- Quick TP Buttons Container
    local QuickTPContainer = Instance.new("Frame")
    QuickTPContainer.Parent = QuickTPFrame
    QuickTPContainer.BackgroundTransparency = 1
    QuickTPContainer.Position = UDim2.new(0.020, 0, 0.300, 0)
    QuickTPContainer.Size = UDim2.new(0.960, 0, 0.650, 0)

    local QuickTPLayout = Instance.new("UIListLayout")
    QuickTPLayout.Parent = QuickTPContainer
    QuickTPLayout.FillDirection = Enum.FillDirection.Horizontal
    QuickTPLayout.HorizontalAlignment = Enum.HorizontalAlignment.Center
    QuickTPLayout.SortOrder = Enum.SortOrder.LayoutOrder
    QuickTPLayout.Padding = UDim.new(0, 8)

    -- Create quick teleport buttons
    local quickTeleports = {
        {name = "🏠 Spawn", cframe = CFrame.new(0, 5, 0), color = Color3.fromRGB(0, 200, 0)},
        {name = "🏪 Shop", cframe = CFrame.new(100, 5, 0), color = Color3.fromRGB(255, 165, 0)},
        {name = "🌊 Ocean", cframe = CFrame.new(500, 5, 500), color = Color3.fromRGB(0, 150, 255)},
        {name = "🏔️ Mountain", cframe = CFrame.new(-200, 50, -200), color = Color3.fromRGB(139, 69, 19)},
    }

    for i, tp in ipairs(quickTeleports) do
        local QuickTPBtn = Instance.new("TextButton")
        QuickTPBtn.Name = "QuickTP" .. i
        QuickTPBtn.Parent = QuickTPContainer
        QuickTPBtn.BackgroundColor3 = tp.color
        QuickTPBtn.BorderSizePixel = 0
        QuickTPBtn.Size = UDim2.new(0.200, 0, 1, 0)
        QuickTPBtn.Font = Enum.Font.SourceSansBold
        QuickTPBtn.Text = tp.name
        QuickTPBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
        QuickTPBtn.TextScaled = true
        QuickTPBtn.LayoutOrder = i
        
        local quickBtnCorner = Instance.new("UICorner")
        quickBtnCorner.CornerRadius = UDim.new(0, 6)
        quickBtnCorner.Parent = QuickTPBtn
        
        connections[#connections + 1] = QuickTPBtn.MouseButton1Click:Connect(function()
            safeCall(function()
                player.Character.HumanoidRootPart.CFrame = tp.cframe
                createNotification("📍 Teleported to " .. tp.name:gsub("^[^%s]*%s", ""), tp.color)
            end)
        end)
    end
    ...
    -- TP Player button (Improved)
    connections[#connections + 1] = TPPlayerButton.MouseButton1Click:Connect(function()
        local isVisible = ListOfTpPlayer.Visible
        ListOfTpPlayer.Visible = not isVisible
        ListOfTPIsland.Visible = false
        
        -- Update button appearance
        TPPlayerButton.Text = isVisible and "SELECT" or "CLOSE"
        TPPlayerButton.BackgroundColor3 = isVisible and Color3.fromRGB(0, 150, 255) or Color3.fromRGB(220, 40, 34)
        
        -- Add smooth animation
        if not isVisible then
            ListOfTpPlayer:TweenSize(
                UDim2.new(0.898, 0, 0.200, 0),
                "Out", "Quad", 0.3, true
            )
            updatePlayerList()
            createNotification("👤 Select a player to teleport to", Color3.fromRGB(0, 150, 255))
        else
            ListOfTpPlayer:TweenSize(
                UDim2.new(0.898, 0, 0, 0),
                "In", "Quad", 0.2, true,
                function() ListOfTpPlayer.Visible = false end
            )
        end
    end)

    -- TP Island button (Improved)
    connections[#connections + 1] = TPIslandButton.MouseButton1Click:Connect(function()
        local isVisible = ListOfTPIsland.Visible
        ListOfTPIsland.Visible = not isVisible
        ListOfTpPlayer.Visible = false
        
        -- Update button appearance
        TPIslandButton.Text = isVisible and "SELECT" or "CLOSE"
        TPIslandButton.BackgroundColor3 = isVisible and Color3.fromRGB(0, 255, 127) or Color3.fromRGB(220, 40, 34)
        
        -- Add smooth animation
        if not isVisible then
            ListOfTPIsland:TweenSize(
                UDim2.new(0.898, 0, 0.250, 0),
                "Out", "Quad", 0.3, true
            )
            createNotification("🏝️ Select an island to teleport to", Color3.fromRGB(0, 255, 127))
        else
            ListOfTPIsland:TweenSize(
                UDim2.new(0.898, 0, 0, 0),
                "In", "Quad", 0.2, true,
                function() ListOfTPIsland.Visible = false end
            )
        end
    end)
    ...
    -- ===============================================================
    --                ENHANCED ISLAND TELEPORT SETUP
    -- ===============================================================
    
    -- Create enhanced island buttons
    safeCall(function()
        local islandIndex = 0
        for _, island in ipairs(tpFolder:GetChildren()) do
            if island:IsA("BasePart") then
                local IslandFrame = Instance.new("Frame")
                IslandFrame.Name = "Island_" .. island.Name
                IslandFrame.Parent = ListOfTPIsland
                IslandFrame.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
                IslandFrame.BorderSizePixel = 0
                IslandFrame.Size = UDim2.new(0.950, 0, 0, 50)
                IslandFrame.LayoutOrder = islandIndex
                
                local islandFrameCorner = Instance.new("UICorner")
                islandFrameCorner.CornerRadius = UDim.new(0, 6)
                islandFrameCorner.Parent = IslandFrame
                
                local IslandIcon = Instance.new("TextLabel")
                IslandIcon.Parent = IslandFrame
                IslandIcon.BackgroundTransparency = 1
                IslandIcon.Position = UDim2.new(0.020, 0, 0.200, 0)
                IslandIcon.Size = UDim2.new(0.120, 0, 0.600, 0)
                IslandIcon.Font = Enum.Font.SourceSansBold
                IslandIcon.Text = "🏝️"
                IslandIcon.TextColor3 = Color3.fromRGB(0, 255, 127)
                IslandIcon.TextScaled = true
                
                local IslandName = Instance.new("TextLabel")
                IslandName.Parent = IslandFrame
                IslandName.BackgroundTransparency = 1
                IslandName.Position = UDim2.new(0.150, 0, 0.100, 0)
                IslandName.Size = UDim2.new(0.500, 0, 0.800, 0)
                IslandName.Font = Enum.Font.SourceSansBold
                IslandName.Text = island.Name
                IslandName.TextColor3 = Color3.fromRGB(255, 255, 255)
                IslandName.TextScaled = true
                IslandName.TextXAlignment = Enum.TextXAlignment.Left
                
                local TeleportBtn = Instance.new("TextButton")
                TeleportBtn.Name = "TeleportBtn"
                TeleportBtn.Parent = IslandFrame
                TeleportBtn.BackgroundColor3 = Color3.fromRGB(0, 255, 127)
                TeleportBtn.BorderSizePixel = 0
                TeleportBtn.Position = UDim2.new(0.720, 0, 0.200, 0)
                TeleportBtn.Size = UDim2.new(0.250, 0, 0.600, 0)
                ...
                connections[#connections + 1] = TeleportBtn.MouseButton1Click:Connect(function()
                    safeCall(function()
                        player.Character.HumanoidRootPart.CFrame = island.CFrame + Vector3.new(0, 5, 0)
                        createNotification("🏝️ Teleported to " .. island.Name, Color3.fromRGB(0, 255, 127))
                        
                        -- Auto-close the list after teleporting
                        ListOfTPIsland.Visible = false
                        TPIslandButton.Text = "SELECT"
                        TPIslandButton.BackgroundColor3 = Color3.fromRGB(0, 255, 127)
                    end)
        ...
        if islandIndex == 0 then
            -- Create fallback message if no islands found
            local NoIslandsFrame = Instance.new("Frame")
            NoIslandsFrame.Name = "NoIslandsFrame"
            NoIslandsFrame.Parent = ListOfTPIsland
            NoIslandsFrame.BackgroundColor3 = Color3.fromRGB(70, 70, 70)
            NoIslandsFrame.BorderSizePixel = 0
            NoIslandsFrame.Size = UDim2.new(0.950, 0, 0, 60)
            NoIslandsFrame.LayoutOrder = 0
            
            local noIslandsCorner = Instance.new("UICorner")
            noIslandsCorner.CornerRadius = UDim.new(0, 6)
            noIslandsCorner.Parent = NoIslandsFrame
            
            local NoIslandsText = Instance.new("TextLabel")
            NoIslandsText.Parent = NoIslandsFrame
            NoIslandsText.BackgroundTransparency = 1
            NoIslandsText.Size = UDim2.new(1, 0, 1, 0)
            NoIslandsText.Font = Enum.Font.SourceSansBold
            NoIslandsText.Text = "⚠️ No islands found in workspace"
            NoIslandsText.TextColor3 = Color3.fromRGB(255, 165, 0)
            NoIslandsText.TextScaled = true
        end
    end)
    ...
    local function updatePlayerList()
        safeCall(function()
            ...
            for _, targetPlayer in ipairs(activePlayers) do
                ...
                PlayerFrame.Name = "Player_" .. targetPlayer.Name
                PlayerFrame.Parent = ListOfTpPlayer
                PlayerFrame.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
                PlayerFrame.BorderSizePixel = 0
                PlayerFrame.Size = UDim2.new(0.950, 0, 0, 50)
                PlayerFrame.LayoutOrder = playerIndex
                ...
                PlayerIcon.Position = UDim2.new(0.020, 0, 0.200, 0)
                PlayerIcon.Size = UDim2.new(0.120, 0, 0.600, 0)
                PlayerIcon.Font = Enum.Font.SourceSansBold
                PlayerIcon.Text = "👤"
                PlayerIcon.TextColor3 = Color3.fromRGB(0, 150, 255)
                PlayerIcon.TextScaled = true
                
                local PlayerName = Instance.new("TextLabel")
                PlayerName.Parent = PlayerFrame
                PlayerName.BackgroundTransparency = 1
                PlayerName.Position = UDim2.new(0.150, 0, 0.100, 0)
                PlayerName.Size = UDim2.new(0.450, 0, 0.800, 0)
                ...
                DistanceLabel.Position = UDim2.new(0.600, 0, 0.100, 0)
                DistanceLabel.Size = UDim2.new(0.100, 0, 0.800, 0)
                ...
                connections[#connections + 1] = TeleportBtn.MouseButton1Click:Connect(function()
                    if targetPlayer.Character and targetPlayer.Character:FindFirstChild("HumanoidRootPart") then
                        safeCall(function()
                            ...
                            player.Character.HumanoidRootPart.CFrame = targetPosition + Vector3.new(math.random(-5, 5), 2, math.random(-5, 5))
                            createNotification("👤 Teleported to " .. targetPlayer.Name, Color3.fromRGB(0, 150, 255))
                        ...
                        createNotification("❌ " .. targetPlayer.Name .. " is not available", Color3.fromRGB(255, 0, 0))
                    end
                end)
            ...
            if playerIndex == 0 then
                -- Create message if no players found
                local NoPlayersFrame = Instance.new("Frame")
                NoPlayersFrame.Name = "NoPlayersFrame"
                NoPlayersFrame.Parent = ListOfTpPlayer
                NoPlayersFrame.BackgroundColor3 = Color3.fromRGB(70, 70, 70)
                NoPlayersFrame.BorderSizePixel = 0
                NoPlayersFrame.Size = UDim2.new(0.950, 0, 0, 60)
                NoPlayersFrame.LayoutOrder = 0
                ...
                NoPlayersText.Parent = NoPlayersFrame
                NoPlayersText.BackgroundTransparency = 1
                NoPlayersText.Size = UDim2.new(1, 0, 1, 0)
                NoPlayersText.Font = Enum.Font.SourceSansBold
                NoPlayersText.Text = "😔 No other players in server"
                NoPlayersText.TextColor3 = Color3.fromRGB(255, 165, 0)
                NoPlayersText.TextScaled = true
            end
        end)
    end
